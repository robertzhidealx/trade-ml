...
(*
  Most DB and Game functions interact with the database or make HTTP requests,
  thus are not tested. Testable utility functions are tested here.
*)
...
let test_denormalize _ = assert_equal 59887.4260875 @@ Forecast.denormalize (-0.7461)
